const promiseTestAmanomd = fetch("./amanomd/test.amanomd");
promiseTestAmanomd.then((response) => {
...
function main(text: string): void {
    ...
    amanonagareIndexHtmlTodoLi0.append("Typescriptを導入する(済)");
    amanonagareIndexHtmlTodoLi1.append("scriptで完全にhtmlを制御し、データとロジックを分離する" + text);
